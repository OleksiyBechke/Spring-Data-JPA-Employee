...
public class EmployeeController {
    ...
    public ResponseEntity<EmployeeDtoListResponse> getByPosition(
            @PathVariable(value = "position") String position) {
        List<Employee> list = employeeService.findByPosition(position);
        return (!list.isEmpty()) ?
                ResponseEntity.status(HttpStatus.OK)
                        .body(EmployeeDtoListResponse.of(false,
                                list)) :
    ...
    public ResponseEntity<EmployeeDtoGetLastEntityResponse> getByPhone(
            @PathVariable(value = "phone") String phone) {
        Employee employee = employeeService.findFirstByPhone(phone);
        return employee != null ?
                ResponseEntity.status(HttpStatus.OK)
                        .body(EmployeeDtoGetLastEntityResponse.of(true,
                                employee)) :
